...
public class MobSpawner extends Actor {
    ...
    private static ArrayList<Class<? extends Mob>> standardMobRotation(int depth) {
        switch (depth) {
            ...
            // Prison
            case 6:
                //3x skeleton, 1x thief, 1x swarm，1x viper
                return new ArrayList<>(Arrays.asList(Skeleton.class, Skeleton.class, Skeleton.class,
                        Thief.class,
                        Swarm.class,
                        Viper.class));
            case 7:
                //3x skeleton, 1x thief, 1x DM-100, 1x guard, 1x viper
                return new ArrayList<>(Arrays.asList(Skeleton.class, Skeleton.class, Skeleton.class,
                        Thief.class,
                        DM100.class,
                        Guard.class,
                        Viper.class));
            case 8:
                //2x skeleton, 1x thief, 2x DM-100, 2x guard, 1x necromancer, 3x viper
                return new ArrayList<>(Arrays.asList(Skeleton.class, Skeleton.class,
                        Thief.class,
                        DM100.class, DM100.class,
                        Guard.class, Guard.class,
                        Necromancer.class, Viper.class, Viper.class, Viper.class));
            case 9:
            case 10:
                //1x skeleton, 1x thief, 2x DM-100, 2x guard, 2x necromancer, 1x viper
                return new ArrayList<>(Arrays.asList(Skeleton.class,
                        Thief.class,
                        DM100.class, DM100.class,
                        Guard.class, Guard.class,
                        Necromancer.class, Necromancer.class, Viper.class, Viper.class));
