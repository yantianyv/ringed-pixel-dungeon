...
import com.shatteredpixel.shatteredpixeldungeon.actors.buffs.ElementBuff.ElectroElement;
...
public abstract class Elemental extends Mob {
    ...
    public static class FireElemental extends Elemental {
        ...
        @Override
        protected boolean act() {
            ElectroElement.apply(ElementBuff.Element.PYRO, this, this, 1f);
            return super.act();
        }
    }
    ...
    public static class FrostElemental extends Elemental {
        ...
        @Override
        protected boolean act() {
            ElectroElement.apply(ElementBuff.Element.CRYO, this, this, 1f);
            return super.act();
        }
    }
    ...
    public static class ShockElemental extends Elemental {
        ...
        @Override
        protected boolean act() {
            ElectroElement.apply(ElementBuff.Element.ELECTRO, this, this, 1f);
            return super.act();
        }
    }
    ...
    public static class ChaosElemental extends Elemental {
        ...
        @Override
        protected boolean act() {
            ElectroElement.apply(ElementBuff.Element.ANEMO, this, this, 2f);
            return super.act();
        }
    }
