...
public class CursedWand {
    ...
    public static class SpawnGoldenMimic extends CursedEffect {
        ...
        public boolean effect(Item origin, Char user, Ballistica bolt, boolean positiveOnly) {
            ...
            if (positiveOnly) {
                ...
                Item reward;
                do {
                    reward = Generator.randomUsingDefaults(Random.oneOf(Generator.Category.RING, Generator.Category.ARMOR,
    ...
    public static class RandomTransmogrify extends CursedEffect {
        ...
        public boolean effect(Item origin, Char user, Ballistica bolt, boolean positiveOnly) {
            ...
            Item result;
            do {
                result = Generator.randomUsingDefaults(Random.oneOf(Generator.Category.RING, Generator.Category.ARMOR,
