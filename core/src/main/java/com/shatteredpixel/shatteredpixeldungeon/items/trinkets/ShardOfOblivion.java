...
public class ShardOfOblivion extends Trinket {
    ...
    public static float lootChanceMultiplier(int level) {
        ...
        if (Dungeon.hero.belongings.ring6() != null && !Dungeon.hero.belongings.ring6().isIdentified()) {
            wornUnIDed++;
        }
        if (Dungeon.hero.belongings.ring5() != null && !Dungeon.hero.belongings.ring5().isIdentified()) {
            wornUnIDed++;
        }
        if (Dungeon.hero.belongings.ring4() != null && !Dungeon.hero.belongings.ring4().isIdentified()) {
            wornUnIDed++;
        }
        if (Dungeon.hero.belongings.ring3() != null && !Dungeon.hero.belongings.ring3().isIdentified()) {
            wornUnIDed++;
        }
        if (Dungeon.hero.belongings.ring2() != null && !Dungeon.hero.belongings.ring2().isIdentified()) {
            wornUnIDed++;
        }
        if (Dungeon.hero.belongings.ring1() != null && !Dungeon.hero.belongings.ring1().isIdentified()) {
            wornUnIDed++;
        }
