...
public class v0_6_X_Changes {
    ...
    public static void add_v0_6_3_Changes(ArrayList<ChangeInfo> changeInfos) {
        ...
        changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.RING_EMERALD, null), Messages.get(RingOfDefender.class, "name"),
        ...
        changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.RING_VOID, null), new OldRing().trueName(),
