...
public enum Languages {
	ENGLISH("english",      "en", Status.X_UNFINISH, null, null),
	CHI_SMPL("简体中文",     "zh", Status.O_COMPLETE, new String[]{"Chronie_Lynn_Iwa", "Jinkeloid(zdx00793)", "endlesssolitude"}, new String[]{"931451545", "Budding", "Fatir", "Fishbone", "Hcat", "HoofBumpBlurryface", "Horr_lski", "Lery", "Lyn_0401", "Lyx0527", "Ooooscar", "RainSlide", "ShatteredFlameBlast", "SpaceAnchor", "SunsetGlowTheDOGE", "Teller", "hmdzl001", "leo", "tempest102", "户方狸奴"}),
	...
	CHI_TRAD("繁體中文","zh-hant", Status.X_UNFINISH, new String[]{"JZR", "p2635"}, new String[]{"Fishbone", "Ken4Ro", "Lstron", "Relrin167", "Sotis425", "Yichm", "Zoe096423", "arnolam", "jackymaxj", "redbrow", "shiba", "唐延諭"}),
	...
	CZECH("čeština",        "cs", Status.X_UNFINISH, new String[]{"ObisMike", "novotnyvaclav"}, new String[]{"16cnovotny", "AshenShugar", "Autony", "Block_Vader", "Buba237", "JStrange", "Nerdiniel", "Patrik123", "RealBrofessor", "Thorn_123", "chuckjirka", "emteckos2", "kristanka"}),
	...
	SWEDISH("svenska",      "sv", Status.X_UNFINISH, new String[]{"yeager"}, new String[]{"KeyB", "Moistmemesneverlie", "antonaut", "dotMavriQ", "leowitchhh"}),
