...
public enum Rankings {
    ...
    public void saveGameData(Record rec) {
        ...
        if (belongings.ring1 != null) {
            belongings.backpack.items.add(belongings.ring1);
        }
        if (belongings.ring2 != null) {
            belongings.backpack.items.add(belongings.ring2);
        }
        if (belongings.ring3 != null) {
            belongings.backpack.items.add(belongings.ring3);
        }
        if (belongings.ring4 != null) {
            belongings.backpack.items.add(belongings.ring4);
        }
        if (belongings.ring5 != null) {
            belongings.backpack.items.add(belongings.ring5);
        }
        if (belongings.ring6 != null) {
            belongings.backpack.items.add(belongings.ring6);
        }
