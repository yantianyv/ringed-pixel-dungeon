...
import com.shatteredpixel.shatteredpixeldungeon.items.remains.CrackedTerminal;
...
public enum Catalog {
	...
	static {
		...
		MISC_CONSUMABLES.addItems( Gold.class, EnergyCrystal.class, Dewdrop.class,
				...
				SealShard.class, BrokenStaff.class, CloakScrap.class, BowFragment.class, BrokenHilt.class, TornPage.class, CrackedTerminal.class);
